...
param teamsMobileOrDesktopAppClientId string
param teamsWebAppClientId string
param officeWebAppClientId1 string
param officeWebAppClientId2 string
param outlookDesktopAppClientId string
param outlookWebAppClientId string
param officeUwpPwaClientId string
param outlookOnlineAddInAppClientId string
param outlookMobileAppClientId string
